...
Este Script Python faz os seguintes procedimentos;
    ...
    1) Envia para o esp os parâmetros usado no DPV
        Envio na forma: range_current/V_inicio/V_fim/V_pulso/V_passo/T_pulso/s_rate/e onde 'e' sinaliza o fim do envio
...
data_to_send = ascii(range_current)+"/"+ascii(V_inicio)+"/"+ascii(V_fim)+"/"+ascii(V_pulso)+"/"+ascii(V_passo)+"/"+ascii(T_pulso)+"/"+ascii(s_rate)+"/"+"e"
